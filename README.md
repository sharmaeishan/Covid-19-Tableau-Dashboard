...
Age Group Distribution: Donut chart showing percentage distribution of COVID-19 cases across age groups.

Trend Analysis: Time-series line chart of confirmed, recovered, and death cases to identify pandemic waves and recovery patterns.

Vaccination Analysis: Horizontal bar chart comparing first and second dose administration across states.

Gender-wise Distribution: Donut chart showing male vs female case distribution.

State-wise Testing Details: Bar chart comparing total tests conducted per state.

ICMR Testing Labs: State-wise number of testing laboratories under the Indian Council of Medical Research.
